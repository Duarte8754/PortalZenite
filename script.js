...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Mostrar disciplinas ao mudar a classe
  classe.addEventListener("change", () => {
    ...
    if (classe.value === "9" || classe.value === "10") {
      ...
      mostrarDisciplinas(disciplinasBase); // inicia com base
    }
  });

  // Mostrar disciplinas ao mudar o curso
  ...
  form.addEventListener("submit", async e => {
    ...
    const dados = {
      nome, apelido, bi, dataNascimento, provincia, distrito, telefone, whatsapp, email,
